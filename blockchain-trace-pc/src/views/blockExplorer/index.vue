	...
	<div class="app-container">
		...
		<el-card style="width: 27%;height: 100%;margin-left: 15px;float: right;">
			...
			<el-card style="width: 100%;">
				<div align="center">
					节点<br><br>
				证书节点:<el-tag type="danger">ca.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>	
				排序节点:<el-tag type="warning">orderer.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				需求方节点1:<el-tag>peer0.org1.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				供应商节点1:<el-tag>peer0.org2.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				供应商节点2:<el-tag>peer0.org3.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				需求方节点2:<el-tag>peer0.org4.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				供应商节点3:<el-tag>peer0.org5.trading.com</el-tag>&nbsp;&nbsp;&nbsp;<br><br>
				</div>
			</el-card>
		</el-card>
